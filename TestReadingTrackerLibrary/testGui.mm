...
- (void)test_GetNewBook_Manual_PassMultipleAuthors_ReturnNewBook {
    std::stringstream inputSs, outputSs;
    
    inputSs.str("testAuthor1, testAuthor2\n1234567890\n123456\ntestTitle\ntestPublisher\ntestSeries\nfantasy\n1999-Oct-01\n123\n");
    
    rtl::Book testBook = rtl::CommandLine::GetNewBook(inputSs, outputSs, 0);
    
    XCTAssert(testBook.GetAuthors().size() == 2);
    XCTAssert(testBook.GetAuthors()[0] == "testAuthor1");
    XCTAssert(testBook.GetAuthors()[1] == "testAuthor2");
    XCTAssert(testBook.GetTitle() == "testTitle");
    XCTAssert(testBook.GetPublisher() == "testPublisher");
    XCTAssert(testBook.GetSeries() == "testSeries");
    XCTAssert(testBook.GetGenre() == rtl::Genre::fantasy);
